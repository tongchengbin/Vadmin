export default {
  ...
  FOOD_CATELIST: '/api/admin/food/cate/',
  FOOD_CATELIST_PARENT: '/api/admin/food/cate/parent/',
  FOOD_CATELIST_CHILDRENS: '/api/admin/food/cate/childrens/',

  FOOD_FOODLIST: '/api/admin/food/food/',
  FOOD_FOODLIST_SELECT: '/api/admin/food/food/select/',

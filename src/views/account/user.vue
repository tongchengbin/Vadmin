<template>
  <div class="app-container">
    ...
    <div class="filter-container">
        ...
        <el-button size="small" @click="handleCreate" style="margin-left: 10px;" type="primary" icon="el-icon-edit">添加</el-button>
      </div>
    <!--用户列表-->
    <el-table size="mini" :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
    ...
    <el-dialog  :visible.sync="dialogFormVisible" custom-class="usereidt">
        <el-form  size="mini" ref="dataForm" :model="formData" label-position="left" label-width="80px" label-suffix=":"  style='width: 600px; margin: auto auto;font-size: 13px;'>
          ...
          <el-form-item size="mini" label="角    色">
            <template>
              <el-transfer size="mini"  :titles="['所有角色', '当前角色']"  v-model="formData.roles" :data="RolesData"></el-transfer>
            </template>
          </el-form-item>
          <el-form-item size="mini" label="管理员">
            <el-switch v-model="formData.is_admin"></el-switch>
          </el-form-item>

<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="" align="right" type="primary" icon="el-icon-edit" @click="handleCreate">ADD</el-button>
    </div>
    <el-table v-loading="Loading" :data="list" stripe border style="width: 100%">
      ...
      <el-table-column prop="classificatio" label="分类" />
      ...
      <el-table-column align="center" label="状态" width="100">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.online" type="success">出售中</el-tag>
      ...
      <el-table-column align="center" label="动作" width="200">
        <template slot-scope="scope">
          ...
          <el-button type="warning" size="small" icon="el-icon-edit" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="编辑" :visible.sync="dialogVisible" style="padding-bottom: 30px;border-radius: 5px">
      <el-form :model="temp" label-position="left" label-width="70px" style="width: 600px; margin-left:50px; ">
        ...
        <el-form-item v-if="dialogStatus=='create'" label="资源名称">
          <el-input v-model="temp.course_title" />
        </el-form-item>
        <el-form-item label="分类">
          <el-input v-model="temp.classification" />
        </el-form-item>
        <el-form-item label="描述">
          <el-input v-model="temp.frist_img" />
        </el-form-item>
        <el-form-item label="内容">
          <el-input v-model="temp.content" type="textarea" />
        </el-form-item>
        <el-form-item label="连接">
          <el-input v-model="temp.tburl" />
        </el-form-item>
        <el-form-item label="资源">
          <el-input v-model="temp.res" />
        </el-form-item>
        <el-form-item label="上线">
          <el-switch v-model="temp.online" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="warnin" @click="dialogVisible = false">Calcel</el-button>
